...
export default class Receivejob extends Component {
    ...
    Showdata() {
        ...
        fetch(Linkurl.returnURL.url + "c_Receivejob.php?module=Showdata&userID=" + sessionStorage.getItem('sessLoginID'))
                ...
                <div className="ContenBK w3-row-padding w3-margin-bottom">
                    ...
                    <div className="w3-container">
                        ...
                        <ul className="w3-ul w3-card-4 w3-white">
                            ...
                            {
                                Mydata.map(item => (
                                    <Link key={item.ID} to={{ pathname: "/Readqrcode", receiveID: item.ID, frmstr: '1' }}>
